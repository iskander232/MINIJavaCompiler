...
void ScopeLayerTree::AddMapping(std::pair<Symbol, Symbol> name, ScopeLayer* layer) {
...
ScopeLayer* ScopeLayerTree::GetFunctionScopeByName(std::pair<Symbol, Symbol> name) {
  if (layer_mapping_.find(name) == layer_mapping_.end()) {
