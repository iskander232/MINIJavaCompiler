...
#include <Types/Object.h>
 ...
 public:
  ...
  void DeclareFunction(std::pair<Symbol, Symbol> symbol, std::shared_ptr<FunctionObject> func);
  void Put(Symbol symbol, std::shared_ptr<Object> value);
  std::shared_ptr<Object> Get(Symbol symbol);
  std::shared_ptr<FunctionObject> GetFunc(std::pair<Symbol, Symbol> func_name);
  bool Has(Symbol symbol);
  bool HasFunc(std::pair<Symbol, Symbol> func_name);
