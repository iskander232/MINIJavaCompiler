...
void ScopeLayer::DeclareFunction(std::pair<Symbol, Symbol> symbol, std::shared_ptr<FunctionObject> func) {
...
bool ScopeLayer::HasFunc(std::pair<Symbol, Symbol> func_name) {
...
std::shared_ptr<FunctionObject> ScopeLayer::GetFunc(std::pair<Symbol, Symbol> func_name) {
  ScopeLayer* current_layer = this;
